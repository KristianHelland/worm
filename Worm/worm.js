...
//sjekker om griden er riktig størrelse om den ikkke er det så legger den til 1
let grid =[]
...
document.addEventListener('keydown', (event) => {
    ...
    //gir spilleren mmulighet til å bruke WASD og piltastene til å bevege seg
...
function gameLoop(){
    if(play){
        ...
        //lager et nytt eple om det forrige har blitt spist 
        else{
